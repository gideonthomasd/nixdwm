...
--myLayoutKeys = [ ("M1-t", sendMessage $ JumpToLayout "tall")
--               , ("M1-s", sendMessage $ JumpToLayout "spirals")
--                , ("M1-b", sendMessage $ JumpToLayout "tabs")
...
myKeys =
    ...
    -- This is used to push windows to tabbed sublayouts, or pull them out of it.
        ...
        , ("C-.", onGroup W.focusUp')    -- Switch focus to next tab
        , ("C-,", onGroup W.focusDown')  -- Switch focus to prev tab
    ...
    -- Toggle them to hide and it sends them back to hidden workspace (NSP).
        ...
        --, ("C-S-x", namedScratchpadAction myScratchPads "mocp -x")
    ...
    -- choose.  Or, type 'SUPER+F2' to set a random wallpaper.
        , ("M-<F5>", spawn "sxiv -r -q -t -o /home/phil/Pictures/wallpapers/*")
        , ("M-<F6>", spawn "feh --bg-scale --randomize ~/Pictures/wallpapers/*")

    -- KB_GROUP Controls for mocp music player (SUPER-u followed by a key)
        , ("M-u p", spawn "mocp --play")
        , ("C-S-n", spawn "mocp --next")
        , ("C-S-p", spawn "mocp --previous")
        , ("C-S-<Space>", spawn "mocp --toggle-pause")
        , ("C-S-x", spawn "mocp -x")
...
main = do
    ...
    xmonad $ ewmh def
        ...
        , logHook = dynamicLogWithPP $ namedScratchpadFilterOutWorkspacePP $ xmobarPP
              ...
              , ppTitle = xmobarColor "#ff66b2" "" . shorten 30               -- Title of active window
