...
export SEP1="^c#888888^  ["
export SEP2="^c#888888^]"
...
. "$DIR/bar-functions/dwmcpu"
. "$DIR/bar-functions/dwmram"
. "$DIR/bar-functions/dwmmailweather"
. "$DIR/bar-functions/dwmdate"
. "$DIR/bar-functions/dwmtime"
...
do
  ...
  #  dispstr="$dispstr$(dwm_cmus)"
   ...
   # dispstr="$dispstr$(dwm_ccurse)"
    dispstr="$dispstr$(dwmcpu)"
    dispstr="$dispstr$(dwmram)"
    dispstr="$dispstr$(dwmmailweather)"
    dispstr="$dispstr$(dwmdate)"
    dispstr="$dispstr$(dwmtime)"
