...
keys = [
    ...
    #Key([mod], "s", lazy.spawn("xmenu.sh && scrot"), desc="launch xmenu"),
	 Key([mod], "o", lazy.layout.maximize(), desc="max Qtile"),
...
class Commands:
	...
	def get_ls(self):
		return check_output(['/home/phil/.config/polybar/scripts/weather.sh']).decode("utf-8").replace("\n","")
            ...
            [
	           ...
	           # mouse_callbacks={'Button1': lambda: qtile.cmd_spawn("st -e storage.sh")},
                ...
                widget.Volume(
                    ...
                    font="Inconsolata for powerline",
                    fontsize=18,
                    mouse_callbacks={'Button3': lambda: qtile.cmd_spawn("xfce4-terminal -e pulsemixer")},
                ),
